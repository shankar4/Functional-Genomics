Note: Subsections can be collapsed for easy navigation. This option is an user installed extension (not native to md) at present. To view in that format, please install [Tampermonkey](https://github.com/OpenUserJs/OpenUserJS.org/wiki/Userscript-beginners-HOWTO) manager on Chrome (or Mozilla Firefox) and then install [Github Collapse Markdown](https://openuserjs.org/scripts/Mottie/GitHub_Collapse_Markdown). Both are user-verified and safe, and have open-source MIT-license. To turn off or uninstall the manager click at the Chrome Menu and click on "More Tools" and  "Extensions."
...
* August 2017 – Dec 2018, Leave of Absence, Goal: Build the infrastructure for research and training in Precision Medicine systems (AHA Definition)
